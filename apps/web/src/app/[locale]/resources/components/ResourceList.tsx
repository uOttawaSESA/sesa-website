"use client";
import type { ResourceFilters } from "@repo/api/routers/resource";
            ...
            <div className="flex justify-center md:mt-12 md:block">
                ...
                <div className="pointer-events-none select-none">
                    <Image
                        ...
                        className="fade-from-bottom-bg absolute -bottom-1 left-1/2 z-0 h-[196px] -translate-x-1/2 transform object-cover object-bottom md:-bottom-18" // Reduced height crops the top
                        width={1200}
                        height={430}
                        alt=""
                    />
