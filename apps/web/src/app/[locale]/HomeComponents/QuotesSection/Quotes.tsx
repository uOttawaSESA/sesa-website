    ...
    return (
        <section className="relative text-white lg:mt-10 lg:mb-0">
            ...
            <div className="pointer-events-none absolute inset-0 z-0 h-full w-full select-none">
                {/* Warm gradient */}
                <div className="fade-from-center-bg absolute top-1/2 right-60 h-480 w-full -translate-y-1/2 bg-[#B1219D]/25 blur-xl md:w-screen" />
                {/* Light gradient */}
                <div className="fade-from-center-bg absolute top-1/2 right-0 h-480 w-full -translate-y-1/2 bg-blueviolet-100/10 blur-xl md:w-[80vw] lg:bg-blueviolet-100/20" />
            </div>
