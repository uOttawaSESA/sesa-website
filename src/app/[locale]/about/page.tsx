        ...
        <div className="min-h-screen text-white relative ">
            ...
            <div className="container relative mx-auto max-w-7xl px-4 py-8">
                ...
                <div className="relative">
                    ...
                    <div className="pointer-events-none absolute left-0 top-0 h-full w-full select-none">
                        {/* Light gradient */}
                        <div className="fade-from-center-bg absolute top-[-10rem] left-[-10rem] h-[70rem] w-[70vw] bg-blueviolet-100 bg-opacity-15 blur-sm" />

                        {/* Warm gradient */}
                        <div className="fade-from-left-bg absolute left-[-10rem] top-[-20rem] h-[90rem] w-full bg-[#B1219D] bg-opacity-15 blur-sm md:w-[60vw]" />

                        {/* Light gradient */}
                        <div className="fade-from-left-bg absolute top-[10rem] left-[-10rem] h-[100rem] w-[80vw] bg-blueviolet-100 bg-opacity-20 blur-sm" />

                        {/* Warm gradient */}
                        <div className="fade-from-center-bg absolute left-1/2 top-[100rem] h-[100rem] w-full -translate-x-1/2 bg-[#B1219D] bg-opacity-25 blur-sm md:w-[100vw]" />
                        ...
                        {/* Light gradient */}
                        <div className="fade-from-right-bg absolute top-[130rem] right-[-6rem] h-[100rem] w-[50vw] bg-blueviolet-100 bg-opacity-20 blur-sm" />
                ...
                <div className="relative mt-56">
                    ...
                    <div className="pointer-events-none absolute left-0 top-0 h-full w-full select-none z-[-1]">
                        ...
                        />
                        {/* Light gradient */}
                        <div className="fade-from-left-bg absolute left-[-6rem] top-[-100rem] h-[200rem] w-[80vw] bg-blueviolet-100 bg-opacity-20 blur-sm" />
