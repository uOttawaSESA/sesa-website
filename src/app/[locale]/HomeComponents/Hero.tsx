    ...
    return (
        <section className="relative flex h-max w-full items-center justify-between px-8 text-white md:ps-32">
            ...
            <div className="relative z-10 max-w-72 sm:max-w-md md:max-w-2xl">
                ...
                <h1 className="my-4 font-heading text-2xl uppercase leading-tight md:text-5xl">
                ...
                <p className="relative flex items-center text-left font-sans text-lg leading-tight text-thistle md:text-xl">
                    {t("purpose")}
                </p>
