...
const Team = () => {
    ...
    return (
        <>
            <section className="mb-12 flex flex-col gap-16 md:mb-24">
                <div className="flex flex-col items-center justify-center gap-4 px-8 md:px-32">
                    ...
                    <p className="text-center font-sans text-base text-thistle md:text-xl">
